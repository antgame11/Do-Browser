import {at as M} from "./Providers-CTFhomsf.js";
var v = {
    exports: {}
}, w, I;
function j() {
    ...
    function h(e) {
        var r = Math.abs(e);
        return r >= l ? Math.round(e / l) + "d" : r >= n ? Math.round(e / n) + "h" : r >= s ? Math.round(e / s) + "m" : r >= c ? Math.round(e / c) + "s" : e + "ms"
    }
    function m(e) {
        var r = Math.abs(e);
        return r >= l ? o(e, r, l, "day") : r >= n ? o(e, r, n, "hour") : r >= s ? o(e, r, s, "minute") : r >= c ? o(e, r, c, "second") : e + " ms"
    }
    function o(e, r, t, a) {
        var f = r >= t * 1.5;
        return Math.round(e / t) + " " + a + (f ? "s" : "")
    }
    return w
}
function O(c) {
    ...
    function n(e) {
        ...
        function i(...u) {
            ...
            let b = 0;
            u[0] = u[0].replace(/%([a-zA-Z%])/g, (y, x) => {
                if (y === "%%")
                    return "%";
                b++;
                const A = n.formatters[x];
            ...
            n.formatArgs.call(C, u),
            (C.log || n.log).apply(C, u)
        }
        ...
        Object.defineProperty(i, "enabled", {
            enumerable: !0,
            configurable: !1,
            get: () => t !== null ? t : (a !== n.namespaces && (a = n.namespaces,
            f = n.enabled(e)),
            f),
            set: u => {
                t = u
    ...
    function F(e) {
        ...
        for (const t of r)
            t[0] === "-" ? n.skips.push(t.slice(1)) : n.names.push(t)
    }
    function d(e, r) {
        let t = 0
          , a = 0
    ...
    function g() {
        const e = [...n.names, ...n.skips.map(r => "-" + r)].join(",");
        return n.enable(""),
        e
    }
    function h(e) {
...
(function(c, s) {
    ...
    function F(o) {
        if (o[0] = (this.useColors ? "%c" : "") + this.namespace + (this.useColors ? " %c" : " ") + o[0] + (this.useColors ? "%c " : " ") + "+" + c.exports.humanize(this.diff),
        !this.useColors)
            return;
        const e = "color: " + this.color;
        o.splice(1, 0, e, "color: inherit");
        let r = 0
          , t = 0;
    ...
    function g() {
        ...
        return !o && typeof process < "u" && "env"in process && (o = n.DEBUG),
        o
    }
    function h() {
        try {
...
export {N as b};
//# sourceMappingURL=browser-UL53X4zq.js.map
