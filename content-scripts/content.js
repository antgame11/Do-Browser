var content = function() {
    ...
    var ss = (U, D, j) => D in U ? is(U, D, {
        enumerable: !0,
        configurable: !0,
        writable: !0,
        value: j
    }) : U[D] = j;
    var $ = (U, D, j) => ss(U, typeof D != "symbol" ? D + "" : D, j);
    var vt, gt;
    ...
    function j(i, e = !1) {
        const t = [];
        if (i.querySelectorAll('iframe[src^="chrome-extension://"], [data-lastpass-root]').forEach(r => t.push(r)), !e) return t;
        const s = document.createTreeWalker(i instanceof ShadowRoot ? i : i.documentElement, NodeFilter.SHOW_ELEMENT, {
            acceptNode: r => D(r) ? NodeFilter.FILTER_ACCEPT : NodeFilter.FILTER_SKIP
        });
        let n;
        for (; n = s.nextNode();) {
    ...
    function bt(i) {
        return i.forEach(e => e.remove()), i.map(e => e.getAttribute("src")).filter(Boolean)
    }
    ...
    const fe = {
        async get() {
            const i = await de();
            return (await chrome.storage.session.get([`cursor-position-${i}`]))[`cursor-position-${i}`]
        },
        async set(i, e) {
            const t = await de();
        ...
        async clear() {
            const i = await de();
            await chrome.storage.session.remove(`cursor-position-${i}`)
        }
    };
    ...
    function X() {
        ...
        i.style.position = "absolute", i.style.top = "0", i.style.left = "0", i.style.pointerEvents = "none", i.style.zIndex = "10000000", i.style.willChange = "transform", i.style.transform = "translate(0, 0)", i.style.transition = `transform ${(ke/1e3).toFixed(2)}s cubic-bezier(0.25, 0.1, 0.25, 1)`;
        const e = i.attachShadow({
                mode: "closed"
            }),
  ...
  `, e.appendChild(t);
        ...
        s.classList.add("cursor"), e.appendChild(s);
        const n = document.createElement("div");
        n.classList.add("ripple"), e.appendChild(n);
        const r = document.createElement("div");
        return r.classList.add("name-label"), r.textContent = "Do Browser", e.appendChild(r), document.body.appendChild(i), q = {
            rootElt: i,
            cursorElt: s,
            nameLabelElt: r,
            rippleElt: n
    ...
    function Re() {
        pe && clearTimeout(pe), pe = window.setTimeout(() => {
            ve()
        }, 2e4)
    }
    Re();
    async function me(i, e) {
        Re();
        const t = X();
        return t.rootElt.style.transform = `translate(${i}px, ${e}px)`, fe.set(i, e), new Promise(s => setTimeout(s, ke))
    }
    async function Ke() {
        const i = X(),
            e = i.cursorElt,
            t = i.rippleElt;
        return e && t && (t.style.transform = "scale(0)", t.style.opacity = "1", e.animate([{
            transform: "scale(1)"
        }, {
            transform: "scale(0.8)",
            offset: .3
            ...
            t.style.transform = "scale(0)", t.style.opacity = "1"
        }), new Promise(s => setTimeout(s, 600))
    }
    async function Et() {
        const i = await fe.get();
        i && (await me(i.x, i.y), Fe())
    }
    async function ve() {
        await fe.clear(), X().rootElt.remove(), q = null
    }
    async function Ct() {
        const i = X();
        i.rootElt.style.display = "none"
    }
    async function St() {
        const i = X();
        i.rootElt.style.display = "block"
    ...
    function It(i, e, t) {
        for (var s = 0, n = e.length, r; s < n; s++)(r || !(s in e)) && (r || (r = Array.prototype.slice.call(e, 0, s)), r[s] = e[s]);
    ...
    var b = {
        ...
        J = function(i, e) {
            return typeof i == "function" ? i(se(e), e) : i
        },
        $e = function(i) {
        ...
        g = function(i, e) {
            var t;
            (t = i.classList).add.apply(t, ne(e))
        },
        L = function(i, e) {
            var t;
            (t = i.classList).remove.apply(t, ne(e))
        },
        Ht = function(i) {
            if (typeof i < "u") try {
                return JSON.parse(i)
        ...
        Vt = function() {
            ...
            return i.prototype.show = function() {
                return g(this.element, this.classNames.activeState), this.element.setAttribute("aria-expanded", "true"), this.isActive = !0, this
        ...
        We = function() {
            ...
            return i.prototype.shouldFlip = function(e, t) {
                ...
                g(this.element, this.classNames.openState), this.element.setAttribute("aria-expanded", "true"), this.isOpen = !0, this.shouldFlip(e, t) && (g(this.element, this.classNames.flippedState), this.isFlipped = !0)
                ...
                g(this.element, this.classNames.focusState)
            }, i.prototype.removeFocusState = function() {
                L(this.element, this.classNames.focusState)
            }, i.prototype.enable = function() {
                L(this.element, this.classNames.disabledState), this.element.removeAttribute("aria-disabled"), this.type === k.SelectOne && this.element.setAttribute("tabindex", "0"), this.isDisabled = !1
            }, i.prototype.disable = function() {
                g(this.element, this.classNames.disabledState), this.element.setAttribute("aria-disabled", "true"), this.type === k.SelectOne && this.element.setAttribute("tabindex", "-1"), this.isDisabled = !0
                ...
                g(this.element, this.classNames.loadingState), this.element.setAttribute("aria-busy", "true"), this.isLoading = !0
        ...
        ze = function() {
            ...
            return Object.defineProperty(i.prototype, "isActive", {
                ...
                var e = this.element;
                g(e, this.classNames.input), e.hidden = !0, e.tabIndex = -1;
        ...
        zt = function(i) {
            ...
            return Object.defineProperty(e.prototype, "placeholderOption", {
                ...
                return this.element.querySelectorAll(":scope > option, :scope > optgroup").forEach(function(n) {
                    Wt(n) ? s.push(t._optionToChoice(n)) : Yt(n) && s.push(t._optgroupToChoice(n))
                }), s
                ...
                return !t.hasAttribute("value") && t.hasAttribute("placeholder") && (t.setAttribute("value", ""), t.value = ""), {
                    ...
                    labelClass: typeof t.dataset.labelClass < "u" ? qe(t.dataset.labelClass) : void 0,
        ...
        switch (e.type) {
            ...
            case b.REMOVE_ITEM: {
                ...
                if (r) {
                    ...
                    o && Xe(o) && o.type === k.SelectOne && (o.value = "")
                }
                Qe(e.item), s = s.filter(function(c) {
                    return c.id !== e.item.id
                });
                break
            }
            case b.REMOVE_CHOICE: {
                Qe(e.choice), s = s.filter(function(h) {
            ...
            case b.HIGHLIGHT_ITEM: {
                ...
                l && l.highlighted !== a && (l.highlighted = a, t && jt(l, a ? t.classNames.highlightedState : t.classNames.selectedState, a ? t.classNames.selectedState : t.classNames.highlightedState));
                break
            }
            default: {
                n = !1;
    ...
    function ei(i, e, t) {
        return (e = ii(e)) in i ? Object.defineProperty(i, e, {
            value: t,
            enumerable: !0,
            configurable: !0,
            writable: !0
    ...
    function W(i) {
        for (var e = 1; e < arguments.length; e++) {
            ...
            e % 2 ? et(Object(t), !0).forEach(function(s) {
                ei(i, s, t[s])
            }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(i, Object.getOwnPropertyDescriptors(t)) : et(Object(t)).forEach(function(s) {
    ...
    function F(i) {
        return Array.isArray ? Array.isArray(i) : st(i) === "[object Array]"
    }
    const si = 1 / 0;
    ...
    function oi(i) {
        return i === !0 || i === !1 || ai(i) && st(i) == "[object Boolean]"
    }
    ...
    const ns = "Extended search is not available",
        li = "Incorrect 'index' type",
        ci = i => `Invalid value for key ${i}`,
        hi = i => `Pattern length exceeds max of ${i}.`,
        ui = i => `Missing ${i} property in key`,
        di = i => `Property 'weight' in key '${i}' must be a positive integer`,
    ...
    function rt(i) {
        let e = null,
            ...
            n = 1,
            r = null;
        if (N(i) || F(i)) s = i, e = ot(i), t = be(i);
        else {
            if (!nt.call(i, "name")) throw new Error(ui("name"));
            const o = i.name;
            if (s = o, nt.call(i, "weight") && (n = i.weight, n <= 0)) throw new Error(di(o));
            e = ot(o), t = be(o), r = i.getFn
        }
        return {
            path: e,
            id: t,
        ...
        const n = (r, o, a) => {
            if (T(r))
                if (!o[a]) t.push(r);
                    ...
                    const h = r[l];
                    if (!T(h)) return;
                    if (a === o.length - 1 && (N(h) || tt(h) || oi(h))) t.push(ri(h));
                    else if (F(h)) {
                        s = !0;
    ...
    function bi(i = 1, e = 3) {
        ...
        return {
            get(n) {
                const r = n.match(yi).length;
                if (t.has(r)) return t.get(r);
                const o = 1 / Math.pow(r, .5 * i),
    ...
    class Ee {
        constructor({
            ...
            this.norm = bi(t, 3), this.getFn = e, this.isCreated = !1, this.setIndexRecords()
        }
        setSources(e = []) {
            this.docs = e
        }
    ...
    function at(i, e, {
        ...
        return n.setKeys(i.map(rt)), n.setSources(e), n.create(), n
    }
    ...
    function Ci(i = [], e = v.minMatchCharLength) {
        let t = [],
            s = -1,
            n = -1,
            r = 0;
    ...
    function Si(i, e, t, {
        ...
        if (e.length > G) throw new Error(hi(G));
        const c = e.length,
            u = i.length,
        ...
        for (let O = 0; O < c; O += 1) {
            ...
            for (; K < H;) re(e, {
                ...
                distance: n,
                ignoreLocation: h
            }) <= m ? K = H : B = H, H = Math.floor((B - K) / 2 + K);
            B = H;
            let _t = Math.max(1, f - H + 1),
                De = o ? u : Math.min(f + H, u) + c,
                z = Array(De + 2);
            z[De + 1] = (1 << O) - 1;
            for (let x = De; x >= _t; x -= 1) {
                let ue = x - 1,
                    yt = t[i.charAt(ue)];
                if (p && (y[ue] = +!!yt), z[x] = (z[x + 1] << 1 | 1) & yt, O && (z[x] |= (w[x + 1] | w[x]) << 1 | 1 | w[x + 1]), z[x] & ts && (A = re(e, {
                        errors: O,
                        currentLocation: ue,
                        expectedLocation: f,
                        distance: n,
        ...
        if (p) {
            const O = Ci(y, a);
            O.length ? l && (Ne.indices = O) : Ne.isMatch = !1
        }
        return Ne
    }
    ...
    class lt {
        constructor(e, {
            ...
            if (u > G) {
                ...
                const m = u % G,
                    d = u - m;
                for (; f < d;) c(this.pattern.substr(f, G), f), f += G;
                if (m) {
                    const p = u - G;
    ...
    class R {
        ...
        static isMultiMatch(e) {
            return ct(e, this.multiRegex)
        }
        static isSingleMatch(e) {
            return ct(e, this.singleRegex)
        }
        search() {}
    }
    ...
    class ht extends R {
        constructor(e, {
            ...
            super(e), this._bitapSearch = new lt(e, {
                location: t,
                threshold: s,
                distance: n,
                includeMatches: r,
    ...
    class ut extends R {
        ...
        search(e) {
            ...
            for (;
                (s = e.indexOf(this.pattern, t)) > -1;) t = s + r, n.push([s, t - 1]);
            const o = !!n.length;
            return {
                isMatch: o,
                score: o ? 0 : 1,
    ...
    const Ce = [wi, ut, Ti, Oi, Li, xi, Ai, ht],
        dt = Ce.length,
        Mi = / +(?=(?:[^\"]*\"[^\"]*\")*[^\"]*$)/,
        Ni = "|";
    ...
    function Di(i, e = {}) {
        return i.split(Ni).map(t => {
            let s = t.trim().split(Mi).filter(r => r && !!r.trim()),
                n = [];
    ...
    const Pi = new Set([ht.type, ut.type]);
    class Fi {
        constructor(e, {
            ...
            this.query = null, this.options = {
                ...
                threshold: l,
                distance: h
            }, this.pattern = t ? e : e.toLowerCase(), this.query = Di(this.pattern, this.options)
        }
        ...
        searchIn(e) {
            ...
            for (let l = 0, h = t.length; l < h; l += 1) {
                ...
                for (let u = 0, f = c.length; u < f; u += 1) {
                    ...
                    if (d) {
                        if (r += 1, a += y, s) {
                            const _ = m.constructor.type;
                            Pi.has(_) ? o = [...o, ...p] : o.push(p)
                        }
                    } else {
                        a = 0, r = 0, o.length = 0;
                        break
    ...
    const oe = {
        ...
        Ae = i => !!(i[oe.AND] || i[oe.OR]),
        Ri = i => !!i[we.PATH],
        Ki = i => !F(i) && it(i) && !Ae(i),
        ft = i => ({
            [oe.AND]: Object.keys(i).map(e => ({
                [e]: i[e]
            }))
        });
    ...
    function pt(i, e, {
        ...
        const s = n => {
            let r = Object.keys(n);
            const o = Ri(n);
            if (!o && r.length > 1 && !Ae(n)) return s(ft(n));
            if (Ki(n)) {
                const l = o ? n[we.PATH] : r[0],
                    h = o ? n[we.PATTERN] : n[l];
                if (!N(h)) throw new Error(ci(l));
                const c = {
                    keyId: be(l),
                    pattern: h
                };
                return t && (c.searcher = Ie(h, e)), c
            }
            let a = {
                children: [],
                operator: r[0]
    ...
    function Gi(i, e, {
        ...
        const n = [];
        return t && n.push(ji), s && n.push(Vi), i.map(r => {
            const {
                idx: o
            } = r, a = {
                item: e[o],
    ...
    class Y {
        constructor(e, t = {}, s) {
            this.options = W(W({}, v), t), this.options.useExtendedSearch, this._keyStore = new fi(this.options.keys), this.setCollection(e, s)
        }
        setCollection(e, t) {
            if (this._docs = e, t && !(t instanceof Ee)) throw new Error(li);
            this._myIndex = t || at(this.options.keys, this._docs, {
        ...
        search(e, {
            ...
            let l = N(e) ? N(this._docs[0]) ? this._searchStringList(e) : this._searchObjectList(e) : this._searchLogical(e);
            return Hi(l, {
                ignoreFieldNorm: a
            }), r && l.sort(o), tt(t) && t > -1 && (l = l.slice(0, t)), Gi(l, this._docs, {
                includeMatches: s,
                includeScore: n
            })
        }
            ...
            const t = pt(e, this.options),
                s = (a, l, h) => {
                    ...
                    for (let u = 0, f = a.children.length; u < f; u += 1) {
                        const m = a.children[u],
                            d = s(m, l, h);
                        if (d.length) c.push(...d);
                        else if (a.operator === oe.AND) return []
                    }
                    return c
                },
    ...
    Y.version = "7.0.0", Y.createIndex = at, Y.parseIndex = Ei, Y.config = v, Y.parseQuery = pt, ki(Fi);
    var Bi = function() {
        function i(e) {
            this._haystack = [], this._fuseOptions = S(S({}, e.fuseOptions), {
                keys: It([], e.searchFields),
                includeMatches: !0
            })
        }
        return i.prototype.index = function(e) {
            ...
            this._fuse || (this._fuse = new Y(this._haystack, this._fuseOptions));
    ...
    var Ui = function(i) {
            for (var e in i)
                if (Object.prototype.hasOwnProperty.call(i, e)) return !1;
            return !0
        },
        Te = function(i, e, t) {
            var s = i.dataset,
            ...
            r && (s.labelClass = ne(r).join(" ")), o && (s.labelDescription = o), t && n && (typeof n == "string" ? s.customProperties = n : typeof n == "object" && !Ui(n) && (s.customProperties = JSON.stringify(n)))
        },
        mt = function(i, e, t) {
        ...
        Wi = {
            containerOuter: function(i, e, t, s, n, r, o) {
                ...
                return g(l, a), l.dataset.type = r, e && (l.dir = e), s && (l.tabIndex = 0), t && (l.setAttribute("role", n ? "combobox" : "listbox"), n ? l.setAttribute("aria-autocomplete", "list") : o || mt(this._docRoot, this.passedElement.element.id, l), l.setAttribute("aria-haspopup", "true"), l.setAttribute("aria-expanded", "false")), o && l.setAttribute("aria-labelledby", o), l
            },
            ...
            itemList: function(i, e) {
                ...
                return g(a, n), g(a, e ? r : o), this._isSelectElement && t && a.setAttribute("role", "listbox"), a
            },
            placeholder: function(i, e) {
                var t = i.allowHTML,
                    s = i.classNames.placeholder,
                    n = document.createElement("div");
                return g(n, s), P(n, t, e), n
            },
            item: function(i, e, t) {
                var s = i.allowHTML,
                ...
                if (g(d, l), e.labelClass) {
                    var p = document.createElement("span");
                    P(p, s, e.label), g(p, e.labelClass), d.appendChild(p)
                } else P(d, s, e.label);
                if (d.dataset.item = "", d.dataset.id = e.id, d.dataset.value = m, Te(d, e, !0), (e.disabled || this.containerOuter.isDisabled) && d.setAttribute("aria-disabled", "true"), this._isSelectElement && (d.setAttribute("aria-selected", "true"), d.setAttribute("role", "option")), e.placeholder && (g(d, f), d.dataset.placeholder = ""), g(d, e.highlighted ? c : u), t) {
                    e.disabled && L(d, u), d.dataset.deletable = "";
                    var y = document.createElement("button");
                    y.type = "button", g(y, h), P(y, !0, J(r, e.value));
                    var _ = J(o, e.value);
                    _ && y.setAttribute("aria-label", _), y.dataset.button = "", n ? d.insertAdjacentElement("afterbegin", y) : d.appendChild(y)
                }
                return d
            },
            choiceList: function(i, e) {
                ...
                return g(s, t), e || s.setAttribute("aria-multiselectable", "true"), s.setAttribute("role", "listbox"), s
            },
            choiceGroup: function(i, e) {
                ...
                g(u, n), h && g(u, o), u.setAttribute("role", "group"), u.dataset.group = "", u.dataset.id = a, u.dataset.value = c, h && u.setAttribute("aria-disabled", "true");
                var f = document.createElement("div");
                return g(f, r), P(f, t, l || ""), u.appendChild(f), u
            },
            choice: function(i, e, t, s) {
                ...
                p.id = e.elementId, g(p, o), g(p, a), s && typeof m == "string" && (m = _e(n, m), m += " (".concat(s, ")"), m = {
                    trusted: m
                });
                var y = p;
                if (e.labelClass) {
                    var _ = document.createElement("span");
                    P(_, n, m), g(_, e.labelClass), y = _, p.appendChild(_)
                } else P(p, n, m);
                if (e.labelDescription) {
                    var w = "".concat(e.elementId, "-description");
                    y.setAttribute("aria-describedby", w);
                    var A = document.createElement("span");
                    P(A, n, e.labelDescription), A.id = w, g(A, u), p.appendChild(A)
                }
                return e.selected && g(p, h), e.placeholder && g(p, f), p.setAttribute("role", e.group ? "treeitem" : "option"), p.dataset.choice = "", p.dataset.id = e.id, p.dataset.value = d, t && (p.dataset.selectText = t), e.group && (p.dataset.groupId = "".concat(e.group.id)), Te(p, e, !1), e.disabled ? (g(p, c), p.dataset.choiceDisabled = "", p.setAttribute("aria-disabled", "true")) : (g(p, l), p.dataset.choiceSelectable = ""), p
            },
            input: function(i, e) {
                var t = i.classNames,
                    s = t.input,
                ...
                return o.type = "search", g(o, s), g(o, n), o.autocomplete = "off", o.autocapitalize = "off", o.spellcheck = !1, o.setAttribute("role", "textbox"), o.setAttribute("aria-autocomplete", "list"), e ? o.setAttribute("aria-label", e) : r || mt(this._docRoot, this.passedElement.element.id, o), o
            },
            dropdown: function(i) {
                var e = i.classNames,
                    t = e.list,
                    s = e.listDropdown,
                    n = document.createElement("div");
                return g(n, t), g(n, s), n.setAttribute("aria-expanded", "false"), n
            },
            notice: function(i, e, t) {
                ...
                switch (P(c, !0, e), g(c, n), g(c, r), g(c, h), t) {
                    case E.addChoice:
                        g(c, o);
                        break;
                    case E.noResults:
            ...
            option: function(i) {
                ...
                return Te(t, i, !0), t.disabled = i.disabled, i.selected && t.setAttribute("selected", ""), t
            }
        },
        Yi = "-ms-scroll-limit" in document.documentElement.style && "-ms-ime-align" in document.documentElement.style,
        zi = {},
        Oe = function(i) {
            if (i) return i.dataset.id ? parseInt(i.dataset.id, 10) : void 0
        },
        ee = "[data-choice-selectable]",
        qi = function() {
            function i(e, t) {
                ...
                var n = i.defaults;
                this.config = S(S(S({}, n.allOptions), n.options), t), wt.forEach(function(_) {
                    s.config[_] = S(S(S({}, n.allOptions[_]), n.options[_]), t[_])
                });
                var r = this.config;
                ...
                if (!a || typeof a != "object" || !(Ut(a) || Xe(a))) throw TypeError(!a && typeof e == "string" ? "Selector ".concat(e, " failed to find an element") : "Expected one of the following types text|select-one|select-multiple");
                var l = a.type,
                    h = l === k.Text;
                (h || r.maxItemCount !== 1) && (r.singleModeForMultiSelect = !1), r.singleModeForMultiSelect && (l = k.SelectMultiple);
                var c = l === k.SelectOne,
                    u = l === k.SelectMultiple,
                    f = c || u;
                ...
                if (this._isTextElement) this.passedElement = new $t({
                    element: a,
                    classNames: r.classNames
                });
                else {
                    var d = a;
                    this.passedElement = new zt({
                        element: d,
                        classNames: r.classNames,
                        template: function(_) {
                            return s._templates.option(_)
                        },
                        extractPlaceholder: r.placeholder && !this._hasNonChoicePlaceholder
                    })
                }
                if (this.initialised = !1, this._store = new Zt(r), this._currentValue = "", r.searchEnabled = !h && r.searchEnabled || u, this._canSearch = r.searchEnabled, this._isScrollingOnIe = !1, this._highlightPosition = 0, this._wasTap = !0, this._placeholderValue = this._generatePlaceholderValue(), this._baseId = Mt(a, "choices-"), this._direction = a.dir, !this._direction) {
                    var p = window.getComputedStyle(a).direction,
                        y = window.getComputedStyle(document.documentElement).direction;
                ...
                if (this._idNames = {
                    ...
                    r.silent || console.warn("Trying to initialise Choices on element already initialised", {
                        element: e
                    }), this.initialised = !0, this.initialisedOK = !1;
                    return
                }
                this.init(), this._initialItems = this._store.items.map(function(_) {
                    return _.value
                })
            }
            return Object.defineProperty(i, "defaults", {
                ...
                if (!(this.initialised || this.initialisedOK !== void 0)) {
                    this._searcher = $i(this.config), this._loadChoices(), this._createTemplates(), this._createElements(), this._createStructure(), this._isTextElement && !this.config.addItems || this.passedElement.element.hasAttribute("disabled") || this.passedElement.element.closest("fieldset:disabled") ? this.disable() : (this.enable(), this._addEventListeners()), this._initStore(), this.initialised = !0, this.initialisedOK = !0;
                ...
                return !s || s.highlighted ? this : (this._store.dispatch(ie(s, !0)), t && this.passedElement.triggerEvent(I.highlightItem, this._getChoiceForOutput(s)), this)
            }, i.prototype.unhighlightItem = function(e, t) {
                if (t === void 0 && (t = !0), !e || !e.id) return this;
                var s = this._store.items.find(function(n) {
                    return n.id === e.id
                });
                return !s || !s.highlighted ? this : (this._store.dispatch(ie(s, !1)), t && this.passedElement.triggerEvent(I.unhighlightItem, this._getChoiceForOutput(s)), this)
            }, i.prototype.highlightAll = function() {
                var e = this;
                return this._store.withTxn(function() {
                    e._store.items.forEach(function(t) {
                        t.highlighted || (e._store.dispatch(ie(t, !0)), e.passedElement.triggerEvent(I.highlightItem, e._getChoiceForOutput(t)))
                    })
                }), this
                ...
                return this._store.withTxn(function() {
                    e._store.items.forEach(function(t) {
                        t.highlighted && (e._store.dispatch(ie(t, !1)), e.passedElement.triggerEvent(I.highlightItem, e._getChoiceForOutput(t)))
                    })
                }), this
                ...
                return this.dropdown.isActive ? this : (e === void 0 && (e = !this._canSearch), requestAnimationFrame(function() {
                    ...
                    t.containerOuter.open(s.bottom, s.height), e || t.input.focus(), t.passedElement.triggerEvent(I.showDropdown)
                }), this)
            }, i.prototype.hideDropdown = function(e) {
                var t = this;
                return this.dropdown.isActive ? (requestAnimationFrame(function() {
                    t.dropdown.hide(), t.containerOuter.close(), !e && t._canSearch && (t.input.removeActiveDescendant(), t.input.blur()), t.passedElement.triggerEvent(I.hideDropdown)
                }), this) : this
            }, i.prototype.getValue = function(e) {
                var t = this,
                    s = this._store.items.map(function(n) {
                ...
                var a = this;
                if (e === void 0 && (e = []), t === void 0 && (t = "value"), s === void 0 && (s = "label"), n === void 0 && (n = !1), r === void 0 && (r = !0), o === void 0 && (o = !1), !this.initialisedOK) return this._warnChoicesInitFailed("setChoices"), this;
                ...
                if (typeof e == "function") {
                    var l = e(this);
                    if (typeof Promise == "function" && l instanceof Promise) return new Promise(function(h) {
                    ...
                    if (!Array.isArray(l)) throw new TypeError(".setChoices first argument function must return either array of choices or Promise, got: ".concat(typeof l));
                ...
                return this.containerOuter.removeLoadingState(), this._store.withTxn(function() {
                    ...
                    e.forEach(function(u) {
                        if ("choices" in u) {
                            ...
                            var d = M(m, !1);
                            a._addChoice(d), d.placeholder && !a._hasNonChoicePlaceholder && (a._placeholderValue = Ue(d.label))
                        }
                    }), a.unhighlightAll()
                ...
                return e === void 0 && (e = !1), t === void 0 && (t = !1), s === void 0 && (s = !1), this._isSelectElement ? (this._store.withTxn(function() {
                    ...
                    var a = function(l) {
                        s ? n._store.dispatch(Ge(l)) : o[l.value] && (l.selected = !0)
                    };
                ...
                return t ? (this._clearNotice(), this._store.dispatch(At(t)), this._searcher.reset(), t.selected && this.passedElement.triggerEvent(I.removeItem, this._getChoiceForOutput(t)), this) : this
                ...
                return e === void 0 && (e = !0), t === void 0 && (t = !1), e && (t ? this.passedElement.element.replaceChildren("") : this.passedElement.element.querySelectorAll(":not([selected])").forEach(function(n) {
                    ...
                    s._store.reset(), n.forEach(function(r) {
                        s._store.dispatch(je(r)), s._store.dispatch(Ve(r))
                    })
                }), this._searcher.reset(), this
                ...
                if (this._canAddItems()) {
                    ...
                    var c = document.createDocumentFragment(),
                        ...
                        f = !1,
                        m = function(d, p, y) {
                            n ? d.sort(kt) : s.shouldSort && d.sort(s.sorter);
                            var _ = d.length;
                            _ = !p && l && _ > l ? l : _, _--, d.every(function(w, A) {
                                var B = w.choiceEl || e._templates.choice(s, w, s.itemSelectText, y);
                                return w.choiceEl = B, c.appendChild(B), (n || !w.selected) && (f = !0), A < _
                            })
                        };
                    a.length && (s.resetScrollPosition && requestAnimationFrame(function() {
                        ...
                        text: $e(n ? s.noResultsText : s.noChoicesText),
                ...
                if (this._isSelectOneElement) {
                    ...
                    if (l || h > 1) {
                        var c = s.querySelector(Q(n.classNames.placeholder));
                        c && c.remove()
                ...
                if (this._notice) {
                    var e = this.choiceList.element.querySelector(Q(this.config.classNames.notice));
                ...
                e != null && this.passedElement.triggerEvent(I.change, {
                    value: e
                })
                ...
                if (!(!s.length || !this.config.removeItems || !this.config.removeItemButton)) {
                    var n = e && Oe(e.parentElement),
                        r = n && s.find(function(o) {
                            return o.id === n
                        });
                ...
                if (this.input.isFocussed)
                    if (e !== null && typeof e < "u" && e.length >= this.config.searchFloor) {
                        ...
                        t !== null && this.passedElement.triggerEvent(I.search, {
                            value: e,
                            resultCount: t
                        })
                ...
                var t = this.config,
                    s = !0,
                    n = "";
                if (s && typeof t.addItemFilter == "function" && !t.addItemFilter(e) && (s = !1, n = J(t.customAddItemText, e)), s) {
                    var r = this._store.choices.find(function(o) {
                        return t.valueComparer(o.value, e)
                    });
                    if (r) {
                        if (this._isSelectElement) return this._displayNotice("", E.addChoice), !1;
                        t.duplicateItemsAllowed || (s = !1, n = J(t.uniqueItemText, e))
                    }
                }
                return s && (n = J(t.addItemText, e)), n && this._displayNotice(n, E.addChoice), s
                ...
                var r = this._notice,
                    o = r && r.type;
                return o !== E.addChoice && (n.length ? this._clearNotice() : this._displayNotice($e(this.config.noResultsText), E.noResults)), this._store.dispatch(Tt(n)), n.length
            }, i.prototype._stopSearch = function() {
                this._isSearching && (this._currentValue = "", this._isSearching = !1, this._clearNotice(), this._store.dispatch(Ot(!0)), this.passedElement.triggerEvent(I.search, {
                    value: "",
                    resultCount: 0
                }))
                ...
                var t = e.keyCode,
                    ...
                    n = e.key.length === 1 || e.key.length === 2 && e.key.charCodeAt(0) >= 55296 || e.key === "Unidentified";
                ...
                var o = this.dropdown.element.querySelector(Q(this.config.classNames.highlightedState));
                ...
                if (t || this._isSelectOneElement) {
                    ...
                    var n = s === C.DOWN_KEY || s === C.PAGE_DOWN_KEY ? 1 : -1,
                        r = e.metaKey || s === C.PAGE_DOWN_KEY || s === C.PAGE_UP_KEY,
                        o = void 0;
                    if (r) n > 0 ? o = this.dropdown.element.querySelector("".concat(ee, ":last-of-type")) : o = this.dropdown.element.querySelector(ee);
                    else {
                        var a = this.dropdown.element.querySelector(Q(this.config.classNames.highlightedState));
                        a ? o = Nt(a, ee, n) : o = this.dropdown.element.querySelector(ee)
                    }
                    o && (Dt(o, this.choiceList.element, n) || this.choiceList.scrollToChildElement(o, n), this._highlightChoice(o)), e.preventDefault()
                }
                ...
                e === void 0 && (e = null);
                var t = Array.from(this.dropdown.element.querySelectorAll(ee));
                if (t.length) {
                    var s = e,
                        n = this.config.classNames.highlightedState,
                        r = Array.from(this.dropdown.element.querySelectorAll(Q(n)));
                    r.forEach(function(o) {
                        L(o, n), o.setAttribute("aria-selected", "false")
                    }), s ? this._highlightPosition = t.indexOf(s) : (t.length > this._highlightPosition ? s = t[this._highlightPosition] : s = t[t.length - 1], s || (s = t[0])), g(s, n), s.setAttribute("aria-selected", "true"), this.passedElement.triggerEvent(I.highlightChoice, {
                        el: s
                ...
                if (t === void 0 && (t = !0), s === void 0 && (s = !1), !e.id) throw new TypeError("item.id must be set before _addItem is called for a choice/item");
                (this.config.singleModeForMultiSelect || this._isSelectOneElement) && this.removeActiveItems(e.id), this._store.dispatch(Ve(e)), t && (this.passedElement.triggerEvent(I.addItem, this._getChoiceForOutput(e)), s && this.passedElement.triggerEvent(I.choice, this._getChoiceForOutput(e)))
            }, i.prototype._removeItem = function(e) {
                if (e.id) {
                    this._store.dispatch(Ge(e));
                    var t = this._notice;
                    t && t.type === E.noChoices && this._clearNotice(), this.passedElement.triggerEvent(I.removeItem, this._getChoiceForOutput(e))
                }
            }, i.prototype._addChoice = function(e, t, s) {
                if (t === void 0 && (t = !0), s === void 0 && (s = !1), e.id) throw new TypeError("Can not re-add a choice which has already been added");
                var n = this.config;
                if (!(!n.duplicateItemsAllowed && this._store.choices.find(function(a) {
                    ...
                    var r = n.prependValue,
                        o = n.appendValue;
                    r && (e.value = r + e.value), o && (e.value += o.toString()), (r || o) && e.element && (e.element.value = e.value), this._clearNotice(), this._store.dispatch(je(e)), e.selected && this._addItem(e, t, s)
                }
            }, i.prototype._addGroup = function(e, t) {
                var s = this;
                if (t === void 0 && (t = !0), e.id) throw new TypeError("Can not re-add a group which has already been added");
                this._store.dispatch(xt(e)), e.choices && (this._lastAddedGroupId++, e.id = this._lastAddedGroupId, e.choices.forEach(function(n) {
                ...
                var e = this,
                    ...
                    s = {};
                typeof t == "function" && (s = t.call(this, Pt, _e, ne));
                var n = {};
                ...
                }), this.choiceList = new Ye({
                    element: e.choiceList(s, n)
                }), this.itemList = new Ye({
                    element: e.itemList(s, n)
                }), this.dropdown = new Vt({
    ...
    const Ji = {
            ...
            main: () => {
                setTimeout(function() {
                    getComputedStyle(document.documentElement).getPropertyValue("--arc-palette-background") !== "" && chrome.runtime.sendMessage({
                        type: "browserIsArc"
                    })
                }, 1e3), chrome.runtime.onMessage.addListener((e, t, s) => {
                    if (e.action === "simulateClick") {
                        const {
                            box: n
                        } = e;
                        return n === null ? (ve(), s({
                            ...
                            try {
                                let r = n.x + n.width / 2,
                                    o = n.y + n.height / 2;
                                n.width > 30 && (r = n.x + 30), await me(r, o), await Ke(), s({
                                    success: !0
                                })
                            } catch (r) {
                                s({
                    ...
                    if (e.action === "simulateClickAt") return (async () => {
                        const {
                            x: n,
                            y: r
                        } = e;
                        await me(n, r), await Ke(), s({
                            success: !0
                        })
                    })(), !0;
                    if (e.action === "clearGlobalCursor") return ve(), s({
                        success: !0
                    }), !1;
                    if (e.action === "hideGlobalCursor") return Ct(), s({
                        success: !0
                    }), !1;
                    if (e.action === "showGlobalCursor") return St(), s({
                        success: !0
                    }), !1;
                    if (e.action === "getExtensionIframes") {
                        const n = Pe(!0);
                        return s({
                            urls: n
                        }), !1
                    }
                    if (e.action === "removeExtensionIframes") {
                        const n = Fe();
                        return s({
                            foundIframes: n.length > 0,
                            urls: n
                        }), !1
                    }
                    return e.action === "makeSelectClickable" && (Xi(), s({
                        success: !0
                    })), !1
                }), Et();

                function i() {
                    const e = new DOMParser().parseFromString('<button id="openSidePanel" style="display: none;">Click to open side panel</button>', "text/html").body.firstElementChild;
                    (e == null ? void 0 : e.tagName) === "BUTTON" && (e.addEventListener("click", function() {
                        chrome.runtime.sendMessage({
        ...
        ae = (gt = (vt = globalThis.browser) == null ? void 0 : vt.runtime) != null && gt.id ? globalThis.browser : globalThis.chrome;

    function le(i, ...e) {}
    const Qi = {
            debug: (...i) => le(console.debug, ...i),
            log: (...i) => le(console.log, ...i),
            warn: (...i) => le(console.warn, ...i),
            error: (...i) => le(console.error, ...i)
        },
        he = class he extends Event {
            constructor(e, t) {
                super(he.EVENT_NAME, {}), this.newUrl = e, this.oldUrl = t
            }
        };
    $(he, "EVENT_NAME", Le("wxt:locationchange"));
    let xe = he;

    function Le(i) {
        var e;
        return `${(e=ae==null?void 0:ae.runtime)==null?void 0:e.id}:content:${i}`
    }
    ...
    function Zi(i) {
        ...
        return {
            run() {
                e == null && (t = new URL(location.href), e = i.setInterval(() => {
                    let s = new URL(location.href);
                    s.href !== t.href && (window.dispatchEvent(new xe(s, t)), t = s)
                }, 1e3))
            }
        }
    }
    const te = class te {
        constructor(e, t) {
            ...
            $(this, "locationWatcher", Zi(this));
            $(this, "receivedMessageIds", new Set);
            this.contentScriptName = e, this.options = t, this.abortController = new AbortController, this.isTopFrame ? (this.listenForNewerScripts({
                ignoreFirstEvent: !0
        ...
        get isInvalid() {
            return ae.runtime.id == null && this.notifyInvalidated(), this.signal.aborted
        }
        get isValid() {
            return !this.isInvalid
        }
        onInvalidated(e) {
            return this.signal.addEventListener("abort", e), () => this.signal.removeEventListener("abort", e)
        }
        block() {
            return new Promise(() => {})
        }
        ...
        requestIdleCallback(e, t) {
            const s = requestIdleCallback((...n) => {
                this.signal.aborted || e(...n)
            }, t);
            return this.onInvalidated(() => cancelIdleCallback(s)), s
        }
        addEventListener(e, t, s, n) {
            var r;
            t === "wxt:locationchange" && this.isValid && this.locationWatcher.run(), (r = e.addEventListener) == null || r.call(e, t.startsWith("wxt:") ? Le(t) : t, s, {
                ...n,
                signal: this.signal
            })
        }
        notifyInvalidated() {
            this.abort("Content script context invalidated"), Qi.debug(`Content script "${this.contentScriptName}" context invalidated`)
        }
        stopOldScripts() {
            window.postMessage({
                type: te.SCRIPT_STARTED_MESSAGE_TYPE,
        ...
        verifyScriptStartedEvent(e) {
            var r, o, a;
            const t = ((r = e.data) == null ? void 0 : r.type) === te.SCRIPT_STARTED_MESSAGE_TYPE,
                s = ((o = e.data) == null ? void 0 : o.contentScriptName) === this.contentScriptName,
                n = !this.receivedMessageIds.has((a = e.data) == null ? void 0 : a.messageId);
            return t && s && n
        }
        listenForNewerScripts(e) {
            let t = !0;
            const s = n => {
                if (this.verifyScriptStartedEvent(n)) {
                    this.receivedMessageIds.add(n.data.messageId);
                    const r = t;
                    if (t = !1, r && (e != null && e.ignoreFirstEvent)) return;
                    this.notifyInvalidated()
                }
            };
            addEventListener("message", s), this.onInvalidated(() => removeEventListener("message", s))
        }
    };
    $(te, "SCRIPT_STARTED_MESSAGE_TYPE", Le("wxt:content-script-started"));
    let Me = te;
    ...
    function ce(i, ...e) {}
    const es = {
        debug: (...i) => ce(console.debug, ...i),
        log: (...i) => ce(console.log, ...i),
        warn: (...i) => ce(console.warn, ...i),
        error: (...i) => ce(console.error, ...i)
    };
    return (async () => {
        try {
            const {
                main: i,
                ...e
            } = Ji, t = new Me("content", e);
            return await i(t)
        } catch (i) {
            throw es.error('The content script "content" crashed on startup!', i), i
        }
    })()
}();
